...
try {
  ...
  // NOTE: do NOT raw-create tables here — this script runs BEFORE
  // `prisma db push`, and db push DROPS any table absent from schema.prisma
  // (learned the hard way: boot-time asset_blobs vanished → generation 42P01).
  // Durable media bytes live in the first-class `AssetBlob` model instead.
} finally {
